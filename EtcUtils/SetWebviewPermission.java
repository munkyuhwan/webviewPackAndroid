package com.WebviewPack.EtcUtils;
...
public class SetWebviewPermission {
    ...
    public void permissionRequest() {
        ...
        if (ContextCompat.checkSelfPermission(this.mActivity, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED ||
